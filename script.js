...
document.querySelector('#close-btn-pck').onclick = () => {
    document.querySelector('.pck-popup').style.display = 'none'; 
}

document.querySelectorAll('#pck-nest1').forEach(image => {
    image.onclick = () =>
    document.querySelector('.pck-popup').style.display = 'block';
});

document.querySelector('#close-btn2-pck').onclick = () => {
    document.querySelector('.pck-popup2').style.display = 'none'; 
}

document.querySelectorAll('#pck-nest2').forEach(image => {
    image.onclick = () =>
    document.querySelector('.pck-popup2').style.display = 'block';
});

document.querySelector('#close-btn3-pck').onclick = () => {
    document.querySelector('.pck-popup3').style.display = 'none'; 
}

document.querySelectorAll('#pck-nest3').forEach(image => {
    image.onclick = () =>
    document.querySelector('.pck-popup3').style.display = 'block';
});

document.querySelector('#close-btn4-pck').onclick = () => {
    document.querySelector('.pck-popup4').style.display = 'none'; 
}

document.querySelectorAll('#pck-nest4').forEach(image => {
    image.onclick = () =>
    document.querySelector('.pck-popup4').style.display = 'block';
});

document.querySelector('#close-btn5-pck').onclick = () => {
    document.querySelector('.pck-popup5').style.display = 'none'; 
}

document.querySelectorAll('#pck-nest5').forEach(image => {
    image.onclick = () =>
    document.querySelector('.pck-popup5').style.display = 'block';
});
